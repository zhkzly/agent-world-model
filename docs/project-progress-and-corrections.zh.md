...
- `codex_sdk` 已作为真实 `AgentBackend` 接入：配置、provider、registry、SDK 缺失处理、sandbox 策略、isolated workspace、invocation record 和 implementation candidate manifest 路径均走统一 contract。
