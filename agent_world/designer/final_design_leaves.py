...
def _tool_batch_prompt(
    ...
    return _prompt(
        ...
        instruction=(
            ...
            "required_scopes_by_actor and visible_fields_by_actor must cover every frozen actor; "
            "visibility may use only exact top-level observation_schema fields. Framework derives "
