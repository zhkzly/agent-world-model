...
from agent_env_foundry.answer_sources import (
    AnswerSourceContractError,
    validate_answer_field_source_contract,
)
from agent_env_foundry.answer_sources import (
    json_pointer_value as _json_pointer_value,
)
from agent_env_foundry.answer_sources import (
    same_json as _same_json,
)
...
def _validate_answer_field_source_contract(
    ...
    try:
        validate_answer_field_source_contract(capabilities, surface)
    except AnswerSourceContractError as exc:
        raise QualificationV2Error(
