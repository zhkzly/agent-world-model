...
3. Make `reset(None)` build a meaningful coherent default world with enough
   linked data for successful and refused multi-step behavior.
4. Return structured, chainable tool data. Execute state changes against native
