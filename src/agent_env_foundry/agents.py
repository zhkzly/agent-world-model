    ...
    def run(
        ...
        *,
        ...
        input_text = (
            ...
            "requirements that are publicly exercisable through a proposed public tool result, "
            "public state observation, or the canonical reset/reopen lifecycle. External evidence "
            "cannot authorize a stronger product guarantee than the Need, such as hidden "
            "concurrency, interruption, or fault-injection behavior; keep such material as a "
            "non-blocking limitation unless the Need explicitly requests it and its violation is "
            "publicly distinguishable. Stop only at "
    ...
    def review(self, *, need: NeedRecord, brief: DevelopmentBrief) -> EvidenceReview:
        ...
        document = _run_fresh_json_turn(
            ...
            instructions=(
                ...
                "Every mandatory requirement must be publicly testable through the environment's "
                "proposed public behavior or canonical reset/reopen lifecycle. External evidence "
                "does not authorize a stronger product guarantee than the original Need; use "
                "authority_mismatch for an externally sourced requirement that adds hidden "
                "concurrency, interruption, fault injection, or another behavior whose violation "
                "cannot be publicly distinguished. "
